...
## Быстрое создание SSH ключа для GitHub в Ubuntu

Для связи с GitHub, если нет, или что-то случилось с SSH ключом, нужно создать новый:
```bash
ssh-keygen -t ed25519 -C "your_email@example.com"
...
И добавить этот ключ в GitHub: **Settings → SSH and GPG keys → New SSH key**

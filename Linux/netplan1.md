...
## Оглавление
- [Настройка сети в Linux с помощью netplan](#настройка-сети-в-linux-с-помощью-netplan)
  - [Оглавление](#оглавление)
  - [Конфигурационный файл](#конфигурационный-файл)
  - [Простая настройка сети](#простая-настройка-сети)
  - [Применение настроек](#применение-настроек)
  - [Статический маршрут](#статический-маршрут)
  - [Объединение интерфейсов (bonds)](#объединение-интерфейсов-bonds)
  - [Сетевой мост (bridge)](#сетевой-мост-bridge)
  - [Vlan](#vlan)
  - [WiFi](#wifi)
  - [Несколько IP-адресов](#несколько-ip-адресов)
  - [Адрес от DHCP, а DNS вручную](#адрес-от-dhcp-а-dns-вручную)
  - [Отключение netplan и возврат к interfaces](#отключение-netplan-и-возврат-к-interfaces)
  - [Возможные ошибки](#возможные-ошибки)
    - [1. Error in network definition \*.yaml line xxx column yyy: expected mapping](#1-error-in-network-definition-yaml-line-xxx-column-yyy-expected-mapping)
    - [2. wpa\_supplicant: No such file or directory](#2-wpa_supplicant-no-such-file-or-directory)

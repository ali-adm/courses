...
Выпадающие меню делают ваши формы более эффективными, удобными и организованными. Вы можете использовать контейнерный тег `<select>`, чтобы создать выпадающий список. `<select><!--options-->
</select>`

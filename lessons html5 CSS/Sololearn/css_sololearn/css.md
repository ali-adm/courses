...
Selectors Priority: 1 - Inline style; 2 - IDs; 3 - Classes; 4 - Elements.
...
```
Далее примеры кода HTML-CSS будут следовать без пояснительных надписей. Сначала будет следовать фрагмент html, за ним - css. По тегам html и селекторам css можно узнать где какой код.

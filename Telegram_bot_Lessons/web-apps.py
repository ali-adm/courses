# Видео находится по адресу: https://youtu.be/y65BZbNB0YA
# Для работы бота необходимо установить библиотеку aiogram версии не выше 2.5, иначе не работает executor
# pip install -v "aiogram==2.25.1"
# либо, если в системе уже есть aiogram более поздней версии -
# pip install --force-reinstall -v "aiogram==2.25.1"
# Полноценные Web-приложения в телеграм.
